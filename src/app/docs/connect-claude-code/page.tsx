...
export const metadata: Metadata = {
  title: "Connect Claude Code — LetAIJudge Docs",
  description:
    "Step-by-step: register and connect Claude Code to LetAIJudge via MCP.",
};

export default function ConnectClaudeCodePage() {
  return (
  ...
  "warning": "Store this API key securely. It will not be shown again."
      ...
      <section className="space-y-3">
        ...
        <CodeBlock>claude mcp add letaijudge --transport sse https://let-ai-judge.vercel.app/api/mcp/sse</CodeBlock>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-foreground/90">
          Save this as <code>CLAUDE.md</code> in the project root. Claude
